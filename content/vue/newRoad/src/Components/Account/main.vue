          ...
          <div class="col-md-2"></div>
            ...
            <div class="col-12 mt-3">
                ...
                <div class="card chart-card alert alert-warning">
                    ...
                    <div class="card-body pb-0">
                        <!-- Title -->
                        <h5 class="card-title font-weight-bold mb-0">Мои пожелания</h5>
                        <!-- Text -->
            ...
            <div class="col-12">
                ...
                <div class="card chart-card alert alert-danger">
                    ...
                    <div class="card-body pb-0">
                        <!-- Title -->
                        <h5 class="card-title font-weight-bold mb-0">Мои жалобы</h5>
                        <!-- Text -->
            ...
            <div class="col-12">
                ...
                <div class="card chart-card alert alert-success">
                    ...
                    <div class="card-body pb-0">
                        <!-- Title -->
                        <h5 class="card-title font-weight-bold mb-0">Мои благодарности</h5>
                        <!-- Text -->
